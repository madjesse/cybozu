...
for facility_jp_name, facility_en_name in data.FACILITY.items():
	...
	if facility_jp_name == "継続支援トラビズ" or facility_jp_name == "継続支援コネクトワークス大通東" or facility_jp_name == "継続支援プラスタ" or facility_jp_name == "就労支援トライズ 大通" or facility_jp_name == "就労支援トライズ" or facility_jp_name == "就労支援ブリッジ":
		continue
	...
	for category_tuple in category_tuple_list[15:16]:
		file_index = 1 
